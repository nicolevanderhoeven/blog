...
**Spice Runner** is a browser-based endless runner game built as a demo app for the talk [*The Spice Must Flow: The Fremen Guide to Sustainable Observability*](/blog/20251105-the-spice-must-flow/), first presented at [Øredev 2025](https://oredev.org/) in Malmö, Sweden.
...
![Spice Runner — a sustainable observability demo](/assets/spice-runner.png)
...
- **[k6](https://k6.io)** for load testing the leaderboard API
