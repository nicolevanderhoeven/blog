...
![JMeter's starting screen: a fresh new test plan](/assets/01-jmetergui.png)
...
![JMeter comes with a native distributed testing mode](/assets/02-jmeterdistributed.svg)
...
![Adding listeners like View Results Tree in JMeter lets you visualize results in different ways](/assets/03-jmeterlistener.png)
...
![JMeter's built-in HTML dashboard is limited but functional](/assets/04-jmeterhtmlreport.png)
...
![Oracle's changing Java licensing can cause confusion for JMeter users](/assets/05-javalicense.png)
...
![In an independent test by Rafaela Azevedo, JMeter took up 760 MB of memory](/assets/06-jmeterbenchmark.png)

Source: [Rafaela Azevedo](https://azevedorafaela.com/2020/07/06/load-tests-jmeter-vs-k6/)

Meanwhile, k6 took up 256 MB of memory.

![In an independent test by Rafaela Azevedo, k6 took up 256 MB of memory compared to JMeter's 760 MB for the same test](/assets/07-k6benchmark.png)

Source: [Rafaela Azevedo](https://azevedorafaela.com/2020/07/06/load-tests-jmeter-vs-k6/)

Rafaela's findings are further affirmed by our own benchmarks.

![A comparison of maximum throughput and memory for the most popular open-source load testing tools](/assets/08-internalbenchmarks.png)
...
![JMeter's startup screen warns users not to use the GUI mode for load testing](/assets/09-jmeterguimodewarning.png)
...
![This is the error that JMeter throws when you attempt to open a test plan that includes a plugin you don't have installed locally](/assets/10-jmeterpluginerror.png)
