---
title: "Guide to Load Testing Websites"
date: 2023-01-12T17:12:42Z
draft: false
tags: ['english', 'load testing', 'performance', 'k6.io', 'text']
---

*Original article [here](https://k6.io/docs/testing-guides/load-testing-websites/), written for k6.io*
...
![Snapshots over time of webpage elements rendering on a browser](/assets/frontend-rendering.png "Snapshots over time of webpage elements rendering on a browser")
...
![Backend components](/assets/backend-performance.png "Backend components of an application")
...
![Backend performance often contributes significantly to overall user experience](/assets/Frontend-Backend-LoadTesting.png "Backend performance often contributes significantly to overall user experience")
...
![Hybrid of frontend and backend performance testing](/assets/hybrid-testing.png "In hybrid load testing, both the frontend and backend are tested")
